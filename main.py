...
AUTHORIZED_SENDER = "+4917622149679"
...
def run_workflow():
    ...
    if received_message:
        ...
        translated_message = asyncio.run(
            translate_message(received_message, source_lang="auto", target_lang="en")
        )
        ...
        translated_response = asyncio.run(
            translate_message(response, source_lang="auto", target_lang=translation_choice)
        )
